...
var SuggestionsOverlay = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SuggestionsOverlay, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", _extends({}, useStyles.inline(style, {
        position: position,
        left: left,
        top: top
      }), {
...
var MentionsInput = /*#__PURE__*/function (_React$Component) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getInputProps", function () {
      ...
      keys(propTypes));
      return _objectSpread(_objectSpread(_objectSpread({}, props), style('input')), {}, {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelect", function (ev) {
      ...
      if (isComposing) return; // keep track of selection range / caret position
